...
class TestSubscriber(TestCase):
    ...
    def test_subscriber(self):
        audit = Audit(job_name="test_subscriber", req_message="dmaap_listener")
        expected_notification = notification.mock_notification()
        mock_get_patcher = patch('requests.get')
        notific1 = ['{"undeployed-policies":[{"policy-type":"onap.policies.firewall","policy-type-version":"1.0.0",'
        ...
        obj = Subscriber()
        obj.reconfigure(audit)
        message = obj.get_messages()
